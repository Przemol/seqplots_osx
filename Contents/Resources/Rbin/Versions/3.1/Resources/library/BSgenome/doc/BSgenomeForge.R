...
###################################################
### code chunk number 1: BSgenomeForge.Rnw:194-197
###################################################
library(Biostrings)
...
###################################################
### code chunk number 2: BSgenomeForge.Rnw:426-437
###################################################
library(BSgenome)
...
###################################################
### code chunk number 3: BSgenomeForge.Rnw:450-452 (eval = FALSE)
###################################################
## library(BSgenome)
...
###################################################
### code chunk number 4: BSgenomeForge.Rnw:675-680
###################################################
library(BSgenome)
seed_files <- system.file("extdata", "GentlemanLab", package="BSgenome")
...
###################################################
### code chunk number 5: BSgenomeForge.Rnw:695-697 (eval = FALSE)
###################################################
## library(BSgenome)
...
###################################################
### code chunk number 6: BSgenomeForge.Rnw:739-740
###################################################
sessionInfo()
