...
###################################################
### code chunk number 42: rmsk.e2f3 (eval = FALSE)
###################################################
## library (rtracklayer)
...
###################################################
### code chunk number 43: uwDgfEncodeExample (eval = FALSE)
###################################################
...
###################################################
### code chunk number 44: trackAndTableNameDiscovery (eval = FALSE)
###################################################
## mySession <- browserSession ()
## genome(mySession) <- "hg19"
...
###################################################
### code chunk number 45: session-info
###################################################
  sessionInfo()
