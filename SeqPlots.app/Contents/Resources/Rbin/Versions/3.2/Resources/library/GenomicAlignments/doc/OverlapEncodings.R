...
###################################################
### code chunk number 27: nhitPerQuery-and-nhitPerSubject
###################################################
...
###################################################
### code chunk number 28: U1.GAL_ntx
###################################################
...
###################################################
### code chunk number 29: U1.GAL_ntx_again (eval = FALSE)
###################################################
...
###################################################
### code chunk number 30: U1.uqnames_ntx
###################################################
...
###################################################
### code chunk number 31: U1.exbytx_nOV10
###################################################
...
###################################################
### code chunk number 32: top-10-transcripts-based-on-U1.exbytx_nOV10
###################################################
head(sort(U1.exbytx_nOV10, decreasing=TRUE), n=10) 


###################################################
### code chunk number 33: U3.OV00
###################################################
U3.OV00 <- findOverlaps(U3.GALP, exbytx, ignore.strand=TRUE)


###################################################
### code chunk number 34: length-of-U3.OV00
###################################################
length(U3.OV00)


###################################################
### code chunk number 35: U3.GALP_ntx
###################################################
...
###################################################
### code chunk number 36: U3.GALP_ntx_again (eval = FALSE)
###################################################
...
###################################################
### code chunk number 37: U3.uqnames_ntx
###################################################
...
###################################################
### code chunk number 38: U3.exbytx_nOV10
###################################################
...
###################################################
### code chunk number 39: top-10-transcripts-based-on-U3.exbytx_nOV10
###################################################
head(sort(U3.exbytx_nOV10, decreasing=TRUE), n=10)


###################################################
### code chunk number 40: U1.grl_and_U1.grlf
###################################################
...
###################################################
### code chunk number 41: U1.ovencAB
###################################################
...
###################################################
### code chunk number 43: U1.ovenc_again
###################################################
...
###################################################
### code chunk number 44: U1.ovenc_table
###################################################
...
###################################################
### code chunk number 46: U3.ovenc_table
###################################################
...
###################################################
### code chunk number 47: U1-unique-compatible-encodings
###################################################
sort(U1.ovenc_table[isCompatibleWithSplicing(U1.unique_encodings)])


###################################################
### code chunk number 48: U1.OV00_is_comp
###################################################
...
###################################################
### code chunk number 49: U1.compOV00
###################################################
U1.compOV00 <- U1.OV00[U1.OV00_is_comp]


###################################################
### code chunk number 50: U1.compOV00_again (eval = FALSE)
###################################################
...
###################################################
### code chunk number 51: U1.GAL_ncomptx
###################################################
...
###################################################
### code chunk number 52: U1.GAL_ncomptx_again (eval = FALSE)
###################################################
...
###################################################
### code chunk number 53: U1.uqnames_ncomptx
###################################################
...
###################################################
### code chunk number 54: U1.exbytx_ncompOV10
###################################################
...
###################################################
### code chunk number 55: top-10-transcripts-based-on-U1.exbytx_ncompOV10
###################################################
head(sort(U1.exbytx_ncompOV10, decreasing=TRUE), n=10)


###################################################
### code chunk number 56: U3-unique-compatible-encodings
###################################################
sort(U3.ovenc_table[isCompatibleWithSplicing(U3.unique_encodings)])


###################################################
### code chunk number 57: U3.OV00_is_comp
###################################################
...
###################################################
### code chunk number 58: U3.compOV00
###################################################
U3.compOV00 <- U3.OV00[U3.OV00_is_comp]


###################################################
### code chunk number 59: U3.compOV00_again (eval = FALSE)
###################################################
...
###################################################
### code chunk number 60: U3.GALP_ncomptx
###################################################
...
###################################################
### code chunk number 61: U3.GALP_ncomptx_again (eval = FALSE)
###################################################
...
###################################################
### code chunk number 62: U3.uqnames_ncomptx
###################################################
...
###################################################
### code chunk number 63: U3.exbytx_ncompOV10
###################################################
...
###################################################
### code chunk number 64: top-10-transcripts-based-on-U3.exbytx_ncompOV10
###################################################
head(sort(U3.exbytx_ncompOV10, decreasing=TRUE), n=10)


###################################################
### code chunk number 65: Dmelanogaster
###################################################
...
###################################################
### code chunk number 66: U1-reference-query-sequences
###################################################
...
###################################################
### code chunk number 67: U3.grl_first-and-U3.grl_last
###################################################
...
###################################################
### code chunk number 68: U3-reference-query-sequences
###################################################
...
###################################################
### code chunk number 69: U1.OV00_qstart
###################################################
...
###################################################
### code chunk number 70: txseq
###################################################
txseq <- extractTranscriptSeqs(Dmelanogaster, exbytx)


###################################################
### code chunk number 71: U1.OV00_rqseq-vs-U1.OV00_txseq
###################################################
...
###################################################
### code chunk number 72: U3.OV00_Lqstart
###################################################
...
###################################################
### code chunk number 73: U3.OV00_Rqstart
###################################################
...
###################################################
### code chunk number 75: U3.OV00_Lrqseq_and_Rrqseq
###################################################
...
###################################################
### code chunk number 76: U3.OV00_txseq
###################################################
U3.OV00_txseq <- txseq[subjectHits(U3.OV00)]


###################################################
### code chunk number 77: U3.OV00_Lrqseq-vs-U3.OV00_txseq
###################################################
stopifnot(all(
...
###################################################
### code chunk number 78: U3.OV00_Rrqseq-vs-U3.OV00_txseq
###################################################
stopifnot(all(
...
###################################################
### code chunk number 79: findSequenceHits
###################################################
...
###################################################
### code chunk number 80: which.txseq (eval = FALSE)
###################################################
...
###################################################
### code chunk number 81: U1.sbcompHITS (eval = FALSE)
###################################################
...
###################################################
### code chunk number 82: LOAD_U1.sbcompHITS
###################################################
...
###################################################
### code chunk number 83: U1.uqnames_nsbcomptx
###################################################
...
###################################################
### code chunk number 84: U1.exbytx_nsbcompHITS
###################################################
...
###################################################
### code chunk number 85: top-10-transcripts-based-on-U1.exbytx_nsbcompHITS
###################################################
head(sort(U1.exbytx_nsbcompHITS, decreasing=TRUE), n=10)


###################################################
### code chunk number 86: encoding-based-compatible-implies-string-based-compatible
###################################################
stopifnot(length(setdiff(U1.compOV10, U1.sbcompHITS)) == 0)


###################################################
### code chunk number 87: string-based-compatible-does-NOT-imply-encoding-based-compatible
###################################################
length(setdiff(U1.sbcompHITS, U1.compOV10))


###################################################
### code chunk number 88: U1-unique-almost-compatible-encodings
###################################################
sort(U1.ovenc_table[isCompatibleWithSkippedExons(U1.unique_encodings)])


###################################################
### code chunk number 89: U1.OV00_is_acomp
###################################################
...
###################################################
### code chunk number 90: U1.acompOV00
###################################################
U1.acompOV00 <- U1.OV00[U1.OV00_is_acomp]


###################################################
### code chunk number 91: U1.GAL_nacomptx
###################################################
...
###################################################
### code chunk number 92: U1.exbytx_nacompOV00
###################################################
...
###################################################
### code chunk number 93: U1.OV00_qstart
###################################################
head(subset(U1.OV00_qstart, U1.OV00_is_acomp))


###################################################
### code chunk number 94: U3-unique-almost-compatible-encodings
###################################################
sort(U3.ovenc_table[isCompatibleWithSkippedExons(U3.unique_encodings)])


###################################################
### code chunk number 95: U3.OV00_is_acomp
###################################################
...
###################################################
### code chunk number 96: U3.acompOV00
###################################################
U3.acompOV00 <- U3.OV00[U3.OV00_is_acomp]


###################################################
### code chunk number 97: U3.GALP_nacomptx
###################################################
...
###################################################
### code chunk number 98: U3.exbytx_nacompOV00
###################################################
...
###################################################
### code chunk number 99: U3.OV00_Lqstart-and-U3.OV00_Rqstart
###################################################
...
###################################################
### code chunk number 100: U1.GAL_is_nsj
###################################################
...
###################################################
### code chunk number 101: U1.OV00_is_nsj
###################################################
U1.OV00_is_nsj <- queryHits(U1.OV00) %in% which(U1.GAL_is_nsj)


###################################################
### code chunk number 102: narrow-U1.OV00_is_nsj
###################################################
...
###################################################
### code chunk number 103: U1.nsjOV00_skippedex
###################################################
...
###################################################
### code chunk number 104: U1.exbytx_skippedex
###################################################
...
###################################################
### code chunk number 105: names-of-U1.exbytx_skippedex
###################################################
head(names(U1.exbytx_skippedex))  # transcript names


###################################################
### code chunk number 106: FBtr0089124-skipped-exons
###################################################
U1.exbytx_skippedex$FBtr0089124


###################################################
### code chunk number 107: FBtr0089147-skipped-exons
###################################################
U1.exbytx_skippedex$FBtr0089147


###################################################
### code chunk number 108: sessionInfo
###################################################
sessionInfo()
